...
![图 3：本机三 mode event median（RTX 5090）](assets/A-08-mode-median-bars.png)

> 图 3：人造 `clock64` 负载下的墙钟形状；CSV 见 `docs/results/A-08_async_pipeline_rtx5090.csv`。重画：`python scripts/plot_a08_async_pipeline.py`。
