...
- **Grace / NVLink-C2C**：硬件相干下，系统分配内存可能成为一等公民；本章默认模型仍是离散卡 + PCIe。  
- **多卡 multipath H2D**：单卡先把 pinned / overlap 做对，再考虑更激进的拓扑带宽聚合。
...
6. [Advanced CUDA APIs — Batched Memory Transfers](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-programming-guide/03-advanced/advanced-host-programming.html)
