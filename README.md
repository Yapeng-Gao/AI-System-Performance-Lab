...
| 重画实测图 | `python scripts/plot_b05_unified_memory.py` 等；C-01～C-07：`plot_c0N_*.py` |
...
**当前主线**：Module A ✅；Module B ✅；C-01～C-07 ✅。结构说明见 [`docs/仓库架构与现状.md`](docs/仓库架构与现状.md)。
...
| **Module C** | `article/03_compute_primitives` + `examples/03_compute_primitives` | 🟡 C-01～C-07 ✅；后半候选不阻塞 |
| **Module D–E** | 仅规划文档 | ⏳ |
