...
| 27–29 / C-07～C-09 | Persistent · 设备侧重叠 · named barrier 等 | ✅ C-07 / C-08 已测（[C-08 大纲](CUDA专栏大纲/C-08_pdl.md)）；C-09 仍可裁 |
...
| C | 🟡 | C-01～C-08 ✅；C-09 候选；C-10 未开 |
| D / E | ⏳ | 章表已锁；无代码目录 |

**当前焦点（只一条主线）**：**C-08 PDL** 已收口（5090 定点 1.13×，曲线贴 1×）。C-09～C-10 **不阻塞**。D/E 不开写。
